...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/group": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "input required: academic year name, group name",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github.com_VinCPR_backend_api.createGroupRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/rotation/detail": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "clinical rotation event ID",
                        "name": "eventID",
                        "in": "query",
                        "required": true
                    }
        ...
        "/rotation/reset": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "input required: academic year name",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "github.com_VinCPR_backend_api.createGroupRequest": {
            "type": "object",
            "required": [
                "academic_year_name",
                "name"
